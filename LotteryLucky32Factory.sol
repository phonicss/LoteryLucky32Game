...
contract LotteryLucky32Factory {
    ...
    function createLottery(
        ...
        LotteryLucky32 newLottery = new LotteryLucky32(_gameName, _description, _ownerPercent, _ticketPrice, _deadLine);
        deployedLotteries.push(address(newLottery));
        emit LotteryCreated(address(newLottery), _gameName, _description, _ownerPercent, _ticketPrice, _deadLine);
